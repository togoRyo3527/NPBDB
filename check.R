...
if(!dir.exists("data_check")){
  dir.create("data_check")
  dir.create("./data_check/batting")
  dir.create("./data_check/pitching")
  dir.create("./data_check/fielding")
}
...
xpath
field <- html %>% html_node(xpath = '//*[@id="team_fielding_1B"]') %>% html_table()
field <- html %>% html_table()
